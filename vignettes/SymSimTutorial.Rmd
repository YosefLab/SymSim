...
```{r,cache=T}
ngenes <- 500
true_counts_res <- SimulateTrueCounts(ncells_total=200, ngenes=ngenes, evf_center=1, nevf=10, evf_type="one.population", Sigma=0.5, gene_effects_sd=1, gene_effect_prob=0.3, bimod=0, randseed=0, param_realdata = "zeisel.imputed", scale_s=1,prop_hge=0.02, mean_hge=5, SE=F)
...
observed_counts <- True2ObservedCounts(true_counts=true_counts_res[[1]], meta_cell=true_counts_res[[3]], protocol="nonUMI", alpha_mean=0.1, alpha_sd=0.05, lenslope=0.02, nbins=20, gene_len=gene_len, amp_bias_limit=c(-0.3, 0.3), rate_2PCR=0.7, nPCR1=16, depth_mean=1e5, depth_sd=3e3)
```
...
observed_counts <- True2ObservedCounts(true_counts=true_counts_res[[1]], meta_cell=true_counts_res[[3]], protocol="UMI", alpha_mean=0.05, alpha_sd=0.02, lenslope=0.02, nbins=20, gene_len=gene_len, amp_bias_limit=c(-0.3, 0.3), rate_2PCR=0.7, nPCR1=16, depth_mean=5e4, depth_sd=3e3)
...
```{r,cache=T}
true_counts_res <- SimulateTrueCounts(ncells_total=500, ngenes=ngenes, evf_center=1, nevf=20, evf_type="continuous", n_de_evf=12, impulse = F, vary="s", Sigma=0.4, phyla=Phyla5(), gene_effects_sd=1, gene_effect_prob=0.3, bimod=0, randseed=1, param_realdata = "zeisel.imputed", SE=F)
