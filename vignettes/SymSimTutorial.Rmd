...
```{r,cache=T}
true_counts_res <- SimulateTrueCounts(ncells_total=500, ngenes=ngenes, evf_center=1, nevf=20, evf_type="continuous", n_de_evf=12, vary="s", Sigma=0.4, phyla=Phyla5(), gene_effects_sd=1, gene_effect_prob=0.3, bimod=0, randseed=0, param_realdata = "zeisel.imputed", SE=F)
