...
#' Simulate true counts by sampling from a beta-poisson distribution
#'
#' This function generates evf, gene effect and true counts 
...
DiscreteEVF <- function(phyla,ncells,Sigma,nevf,seed){
	set.seed(seed)
